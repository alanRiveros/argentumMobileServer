            ...
            case OBJTYPE_HERRAMIENTAS:
                ...
                switch (info.ObjIndex) {
                    ...
                    case OBJTYPE_RED_PESCA:
                        this.dueño.enviar(MSG_T01, SKILL_Pesca);
                        break;
                    case OBJTYPE_HACHA_LEÑADOR:
                        this.dueño.enviar(MSG_T01, SKILL_Talar);
                        break;
                    case OBJTYPE_PIQUETE_MINERO:
                        this.dueño.enviar(MSG_T01, SKILL_Mineria);
                        break;
                    case OBJTYPE_MARTILLO_HERRERO:
                        this.dueño.enviar(MSG_T01, SKILL_Herreria);
                        break;
